...
public class GameFragment extends Fragment implements HomeFragment.ILoadedGame {
    ...
    private HomeFragment.ILoadedGame iLoadedGame;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        viewModel = new GameViewModel(this.getContext(), true);
            ...
            for(int col = 0; col < cols; col++) {
                ...
                board[row][col].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (viewModel.isGameOver()) // if the game is over after the last move:
                            game_over_dialog(null);

                        if (viewModel.isAI.getValue()) {
                            if (moved) {
    ...
    public void game_over_dialog(View view) {
    ...
    public void onAttach(Activity activity) {
        ...
        iLoadedGame = (HomeFragment.ILoadedGame) activity;

    }
    @Override
    public void loadGame(SavedGame extraData) {
        viewModel.loadGame(extraData);
    }
}